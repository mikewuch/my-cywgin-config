...
alias cdgit='cd /cygdrive/d/Projects/git'
...
alias gra='g run-app'
alias gpp='g package-plugin'
alias gipwr='g install-plugin ../../plugins/web-common-plugin/grails-web-common-0.0.1.zip ; g run-app '
alias giper='g install-plugin ../../plugins/ea-services-plugin/grails-ea-services-0.0.1.zip ; g run-app'
